        ...
        <div class="parallax-content">
          <div class="container">
            <div class="product-creative-main text-center">
              ...
              <p class="heading-2 product-creative-price text-primary"><a href="tel:#">+234-80265-52227</a></p><a class="button button-lg button-primary" href="#" id="openlog">order now</a>
            </div>
          </div>
        </div>
      </section>
