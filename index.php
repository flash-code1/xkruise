...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="book.php">Book</a>
                    </li>
              ...
              <div class="rd-navbar-aside">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <h2 style="color: #FCAD0C;"><img class="brand-logo-dark" src="images/logo-default-355x118.png" alt="" width="177" height="59"/>
                  </div>
                </div>
      ...
      <!-- FScreen-->
      <section class="section parallax-container section-xl bg-gray-900" data-parallax-img="img/fleet2.jpg">
        <div class="parallax-content">
          <div class="container">
            <div class="product-creative-main text-center">
              ...
              <p class="heading-2 product-creative-price text-primary"><a href="tel:#">+234-80265-52227</a></p><a class="button button-lg button-primary button-raven" data-toggle="modal" href="javascript:void(0)" onclick="openLoginModal();" id="openlog">order now</a>
            </div>
          </div>
        </div>
      </section>
