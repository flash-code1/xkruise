...
if (count([$res2]) == 1) {
    ...
    if ($res3) {
        $_SESSION["Lack_of_intfund_$randms"] = "Registration Suc";
         echo header ("Location: ../ERP/driver.php?message1=$randms");
    } else {
        echo header ("Location: ../ERP/driver.php?message1=$randms");
    }
}
        ...
        echo header ("Location: ../ERP/driver.php?message2=$randms");
    }
    } else {
        $_SESSION["Lack_of_intfund_$randms"] = "Registration Ex";
   echo header ("Location: ../ERP/driver.php?message3=$randms");
    }
}
?>